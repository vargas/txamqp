...
from tests.testlib import TestBase, SupportedBrokers, QPID, OPENAMQ, RABBITMQ
...
class BasicTests(TestBase):
    ...
    def test_consume_no_local(self):
        ...
        self.assertEqual(b"consume_no_local", msg.content.body)
        try:
    ...
    def test_cancel(self):
        ...
        yield channel.basic_cancel(consumer_tag=b"my-consumer")
        ...
        self.assertEqual(b"One", msg.content.body)
        try:
            msg = yield myqueue.get(timeout=1)
        ...
        yield channel.basic_cancel(consumer_tag=b"my-consumer")
        yield channel.basic_cancel(consumer_tag=b"this-never-existed")
    ...
    def test_ack(self):
        ...
        self.assertEqual(b"One", msg1.content.body)
        self.assertEqual(b"Two", msg2.content.body)
        self.assertEqual(b"Three", msg3.content.body)
        self.assertEqual(b"Four", msg4.content.body)
        self.assertEqual(b"Five", msg5.content.body)
        ...
        self.assertEqual(b"Three", msg3b.content.body)
        self.assertEqual(b"Five", msg5b.content.body)
    ...
    def test_get(self):
        ...
        for i in range(1, 11):
            ...
            self.assertEqual(b"Message %d" % i, reply.content.body)
    ...
    def test_get_properties_with_unicode(self):
        ...
        msg["delivery mode"] = 2
        msg['headers'] = {"somekey": "any thing in unicode"}
        ...
        self.assertEqual(reply.method.klass.name, "basic")
        self.assertEqual(reply.method.name, "get-ok")
        self.assertEqual(b"some value", reply.content.body)
        self.assertEqual({"somekey": "any thing in unicode"}, reply.content.properties['headers'])
    ...
    def test_fragment_body(self):
        ...
        large_string = b''.join(b'x' for _ in range(self.client.MAX_LENGTH * 2))
